...
const About = () => {
  return (
    <div className="md:min-h-fit md:h-fit w-full items-center text-center flex flex-col gap-4 md:my-12 mx-auto overflow-x-hidden">
      <h1 className="text-orange-600 font-bold text-4xl">Tentang Kami</h1>
      <div className="flex flex-col md:flex-row w-full items-center">
        <div className="text-justify">
          <h4 className="text-lg md:leading-normal leading-5 text-sec mt-2 mx-12 md:ml-20">
