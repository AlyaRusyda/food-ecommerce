...
const About = () => {
  return (
    <div className="md:min-h-fit md:h-fit w-full items-center text-center flex flex-col gap-8 md:my-12 mx-auto overflow-x-hidden">
      <h1 className="text-orange-600 font-bold text-4xl">About</h1>
      <div className="flex flex-col md:flex-row w-full items-center">
        <div className="text-justify">
          <h4 className="text-lg md:leading-normal leading-5 text-sec mt-2 mb-4 mx-12 md:w-1/2 md:ml-20">
            <span className="font-bold">JanCook</span> adalah ecommerce penjualan makanan matang yang didirikan pada tahun 2023 dengan dilatarbelakangi oleh keberadaan tugas Teaching Factory yang diberikan oleh kak Rian Sopian. 
          </h4>
        </div>
